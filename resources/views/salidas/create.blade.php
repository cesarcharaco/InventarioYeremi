...
<main class="app-content">
  <div class="app-title">
    ...
    <ul class="app-breadcrumb breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="{{ route('salidas.index') }}">Salidas ({{$local->nombre}})</a></li>
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="page-header">
          <h2 class="mb-3 line-head" id="indicators">Salidas  ({{$local->nombre}})</h2><br>
                  ...
                  <div class="form-group">
                    ...
                    <select name="id_insumo" id="id_insumo" class="form-control select2" title="Seleccione el insumo" multiple="multiple">
                      @foreach($insumos as $key)
                        ...
                        <option value="{{ $key->id }}">{{ $key->producto }} |  Serial: {{ $key->serial }} | {{ $key->descripcion }} | En Depósito: <b>{{ $key->deposito }}</b>  | En Local: <b>{{ $key->local }}</b> | Local: <b> {{$key->nombre}}</option>
