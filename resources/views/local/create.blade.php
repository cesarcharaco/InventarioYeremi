...
<main class="app-content">
  <div class="app-title">
    ...
    <ul class="app-breadcrumb breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="#">Registro de Local</a></li>
    </ul>
  </div>
  <div class="tile mb-4">
    <div class="row">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="tile">
          <h4>Registro de Local <small>Todos los campos (<b style="color: red;">*</b>) son requeridos.</small></h4>
          <div class="tile-body">
              ...
              <div class="row">
                <div class="col-md-4">                  
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" placeholder="Ej: Guaribe" name="nombre" id="nombre" required="required" title="Ingrese el Nombre" value="{{ old('nombre') }}">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
          ...
          <div class="tile-footer">
            <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Registrar</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="{{ url('local') }}"><i class="fa fa-fw fa-lg fa-times-circle"></i>Volver</a>
          </div>
            </form>
        </div>
      </div>
