...
<aside class="app-sidebar">
  ...
  <ul class="app-menu">
    ...
    <li class="treeview {{ Request::is('inventario*') ? 'is-expanded':'' }}"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Salidas</span><i class="treeview-indicator fa fa-angle-right"></i></a>
      <ul class="treeview-menu">
        <li><a class="treeview-item {{ Request::is('guaribe') ? 'active':'' }}" href="{{ route('salidas.index') }}"><i class="icon fa fa-circle-o"></i> Guaribe</a></li>
    ...
    <li><a class="app-menu__item {{ Request::is('salidas') ? 'active':'' }}" href="{{ route('salidas.index') }}"><i class="app-menu__icon fa fa-users"></i><span class="app-menu__label">Salidas</span></a></li>
